    ...
    <div className="admin">
      ...
      <div className="main">
        ...
        <div className="admin-content">
          {sec === "dashboard" && (
            <Dashboard data={dashboard} bannerOpen={bannerOpen} onCloseBanner={() => setBannerOpen(false)} onGo={setSec} />
          )}
          {sec === "content" && content && (
            <ContentSection
...
function Dashboard({ data, bannerOpen, onCloseBanner, onGo }: { data: DashboardData | null; bannerOpen: boolean; onCloseBanner: () => void; onGo: (s: Section) => void }) {
